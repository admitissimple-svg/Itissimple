...
const DEMO_DAILY_STEPS: DemoRoutineStep[] = [
  ...
  },
  {
    ...
    subtitle: {
      pt: '30 min de fala natural sobre sua rotina',
      en: '30 min natural talk about your day',
      es: '30 min de charla natural sobre tu día',
      fr: '30 min de conversation naturelle sur votre journée',
      de: '30 Min. natürliches Sprechen über deinen Tag',
      it: '30 min di conversazione naturale sulla tua giornata',
      ja: '日常についてリラックスした会話',
      ko: '하루 일상에 대한 자연스러운 대화',
      zh: '围绕真实日常生活的自然英语交流',
      ru: '30 минут живого общения о вашем дне',
      ar: '30 دقيقة محادثة طبيعية عن يومك',
      tr: 'Gününüz hakkında 30 dk doğal konuşma',
    },
  },
  {
    id: 'memorization',
    ...
    const steps = [
      ...
      },
      {
        ...
        subtitle: hasLiveLessonsScheduled
          ...
          : isEn ? 'Schedule a 30-min conversation' : 'Agende sua sessão de 30 min',
