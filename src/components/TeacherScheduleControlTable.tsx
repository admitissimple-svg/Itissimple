...
export const TeacherScheduleControlTable: React.FC<TeacherScheduleControlTableProps> = ({
  ...
  const availableStudentsForFilter = React.useMemo(() => {
    ...
    // Also include any student appearing in this teacher's lessons
    (lessons || []).forEach((l) => {
                    ...
                    <td className="p-3.5 text-right whitespace-nowrap">
                      <div className="flex items-center justify-end gap-1.5">
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="px-2.5 py-1.5 bg-[#1C4C96] hover:bg-[#062863] text-white font-bold rounded-lg text-[11px] transition flex items-center gap-1 shadow-2xs"
                        ...
                        <a
                          ...
                          className="px-2 py-1.5 bg-white hover:bg-slate-100 border border-slate-300 text-[#062863] font-bold rounded-lg text-[11px] transition flex items-center gap-1 shadow-2xs"
                        ...
                        {isScheduled && (
                          <>
                            <button
                              ...
                              className="px-2.5 py-1.5 bg-[#062863] hover:bg-[#000035] text-white font-bold rounded-lg text-[11px] transition cursor-pointer"
                            ...
                            <button
                              ...
                              className="px-2 py-1.5 bg-amber-100 hover:bg-amber-200 text-amber-900 font-bold rounded-lg text-[11px] border border-amber-300 transition cursor-pointer"
                            ...
                            <button
                              ...
                              className="px-2 py-1.5 bg-white hover:bg-[#9AB4FF]/20 text-[#062863] font-bold rounded-lg text-[11px] border border-[#607EC9]/40 transition cursor-pointer"
                            ...
                            {onCancelLesson && (
                              <button
                                ...
                                className="px-2 py-1.5 bg-rose-50 hover:bg-rose-100 text-rose-700 font-bold rounded-lg text-[11px] border border-rose-200 transition cursor-pointer"
                                title="Cancel Lesson"
                              >
                                Cancel
                              </button>
